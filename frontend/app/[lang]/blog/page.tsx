...
const POSTS = [
    {
        slug: 'how-to-remove-background-from-product-photos',
    ...
    {
        slug: 'download-twitter-videos-and-gifs',
    ...
    },
    {
        ...
        excerpt: 'A complete guide to downloading TikTok videos to iPhone and Android with no watermark — including a method that works in 2026.',
        category: 'Guides',
        readTime: '5 min read',
        date: 'March 8, 2026',
    ...
    },
    {
        ...
        excerpt: 'Discover which hashtags are actually driving reach for Reels in 2026 — and learn how to find the perfect ones for your niche with our free generator.',
        category: 'Strategy',
        readTime: '7 min read',
        date: 'March 4, 2026',
