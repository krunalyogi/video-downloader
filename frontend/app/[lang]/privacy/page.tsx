...
export const metadata: Metadata = {
    ...
    description: 'Privacy Policy and Data Handling details for Kliptify',
};
    ...
    return (
        <div className="w-full max-w-4xl mx-auto px-4 py-16">
            ...
            <div className="prose prose-purple dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                ...
                <p>Kliptify uses the collected data for various purposes, including:</p>
